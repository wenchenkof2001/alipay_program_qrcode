...
(function () {
    ...
    QRCode.prototype.makeImage = function (callback) {
        ...
        if (this._htOption.usingIn) {
            _oContext = my.createCanvasContext(this.canvasId, this._htOption.usingIn)
        }
        else {
            _oContext = my.createCanvasContext(this.canvasId)
        }
        ...
        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                ...
                console.log("行："+ row + "列:" + col + "方块："+ bIsDark + "上:" + nTop + "左:" + nLeft);
            ...
            } else if(row === nCount - 1){
              _oContext.draw(true, callback)
            } else {
              _oContext.draw(true)
            }
        }
